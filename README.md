...
В этом документе я описал основные моменты из задания.
Полное описание задания можно прочитать здесь:
...
1. Запрос sudo ограничен 3 попытками при вводе неправильного пароля. 
