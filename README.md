...
В учебном проекте нужно было запустить сервер на Debian или CentOS с определёнными настройками с помощью виртуальной машины. В бонусной части нужно было установить базу данных, дополнительный сервис для сервера и запустить сайт на WordPress. Запрещено устанавливать графическую оболочку. Я выбрал Debian. Здесь опишу основные моменты из задания. 

Полное описание задания:
[en.subject.pdf](https://github.com/nevniz/Born2beRoot/files/7649626/en.subject.pdf).
Для защиты проекта я составил чек-лист в [Notion](https://invented-hook-b80.notion.site/287f7c7bcdba46c1a2dde774c49dab4b). Туда я записал определения и команды, которые нужны при защите.
