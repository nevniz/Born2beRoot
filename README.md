...
В учебном проекте нужно было запустить сервер на Debian или CentOS с определёнными настройками с помощью виртуальной машины. Я выбрал Debian. Здесь опишу основные моменты из задания. В бонусной части нужно было установить базу данных, дополнительный сервис для сервера и запустить сайт на WordPress. Запрещено устанавливать графическую оболочку.
